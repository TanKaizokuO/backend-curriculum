"""Lesson 11 — three primitives, wired once and reused everywhere.
    ...
    tracer                       -> one span per request, a child span per
                                     database round trip the story cares about.
...
# matters to the story. A span answers "where, inside this one request, did
# the time go", which neither the log line nor the metric can answer alone.
# --------------------------------------------------------------------------
