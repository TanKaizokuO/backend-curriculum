...
microseconds. In production the database is on another machine and a round trip
costs about 1 millisecond. That is roughly 12 times more, and N+1 pays it N
times.
