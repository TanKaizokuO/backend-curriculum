# Lesson 8 — accounts, sessions, and tokens (Python)

The Lesson 7 API with users. The TypeScript twin is
[`Code/js/Lesson_8_code/`](../js/Lesson_8_code/). Both stacks write the same
